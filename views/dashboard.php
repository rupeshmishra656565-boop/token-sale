...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8 md:mb-10 animate-fadeIn" style="animation-delay: 200ms;">
        ...
        <div class="glass-card p-5 shadow-lg group transition-all duration-300 hover:scale-[1.03] hover:border-cyan-500/50">
            ...
            <div class="text-3xl md:text-4xl font-bold text-cyan-400 mt-3 font-heading">$<?php echo rtrim(rtrim(sprintf('%.8f', 1 / TOKEN_RATE), '0'), '.'); ?></div>
            <div class="text-xs text-gray-400">USD per GALAXY</div>
        </div>

        <div class="glass-card p-5 shadow-lg group transition-all duration-300 hover:scale-[1.03] hover:border-green-500/50">
            <div class="flex items-center justify-between">
                ...
                <div class="p-2 bg-green-500/20 rounded-xl text-green-400">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22m0 0l-5.94-2.28m5.94 2.28l-2.28 5.941"></path></svg>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-10">
            ...
            <section id="plans" class="animate-fadeIn" style="animation-delay: 300ms;">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="glass-card p-6 group transition-all duration-300 hover:shadow-2xl hover:shadow-purple-900/50 hover:-translate-y-1">
                        ...
                        <h3 class="text-4xl font-extrabold font-heading mb-2 text-white">$15</h3>
                        <p class="text-gray-400 mb-6 text-sm">Perfect to get started</p>
                        <div class="text-3xl font-extrabold font-heading mb-4"><span class="text-white">15,000</span><div class="text-sm text-gray-400 font-normal mt-1">GALAXY Tokens</div></div>
                        <button onclick="showPaymentOptions(15, 0)" class="btn-secondary w-full py-3 text-base"> Buy Now </button>
                    </div>

                    <div class="glass-card p-6 group transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-900/50 hover:-translate-y-1 border-2 border-cyan-500/50 relative">
                         <div class="absolute -top-4 left-1/2 transform -translate-x-1/2"><div class="px-5 py-1 rounded-full bg-gradient-to-r from-cyan-500 to-cyan-600 text-white text-xs font-bold shadow-lg shadow-cyan-500/50 uppercase tracking-wider">Most Popular</div></div>
                         <div class="flex items-center gap-3 mb-4 mt-5">
                            <div class="p-2.5 bg-cyan-500/20 rounded-xl text-cyan-400"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg></div>
                         ...
                         <div class="mb-4"><div class="text-xl line-through text-gray-500 font-semibold">100,000</div><div class="text-3xl font-extrabold font-heading text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500">125,000</div><div class="text-sm text-yellow-400 font-semibold mt-1">+25% BONUS</div></div>
                        <button onclick="showPaymentOptions(100, 0.25)" class="btn-primary w-full py-3 text-base"> Buy Now </button>
                    </div>

                    <div class="glass-card p-6 group transition-all duration-300 hover:shadow-2xl hover:shadow-green-900/50 hover:-translate-y-1">
                         <div class="flex items-center gap-3 mb-4">
                            <div class="p-2.5 bg-green-500/20 rounded-xl text-green-400"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg></div>
                         ...
                         <div class="mb-4"><div class="text-3xl font-extrabold font-heading text-white">55,000</div><div class="text-sm text-green-400 font-semibold mt-1">+10% BONUS</div></div>
            ...
            <section id="activity" class="animate-fadeIn" style="animation-delay: 400ms;">
                 ...
                 <div class="glass-card p-0 md:p-0 overflow-hidden">
                    <div class="min-h-[200px] relative">
                        <div id="activity-loader" class="absolute inset-0 flex items-center justify-center bg-[var(--bg-card)] z-10">
                            ...
                            <table class="w-full">
                                <thead>
                                    <tr class="border-b border-[var(--border-color)] text-xs sm:text-sm">
                                        ...
                                        <th class="text-left py-3 px-4 text-purple-400 uppercase tracking-wider font-semibold">Amount</th>
                                        <th class="text-left py-3 px-4 text-purple-400 uppercase tracking-wider font-semibold">Status</th>
                    ...
                    <div class="text-center p-4 border-t border-[var(--border-color)]">
                        <a href="index.php?p=wallet" class="text-purple-400 hover:text-purple-300 font-semibold inline-flex items-center gap-2 transition-colors text-sm group"> 
                            View Full History 
        ...
        <div class="lg:col-span-4 space-y-8">
            <section id="referral" class="glass-card p-6 relative overflow-hidden animate-fadeIn" style="animation-delay: 500ms;">
                ...
                <div class="relative z-10">
                    ...
                    <div class="space-y-3">
                        ...
                        <button onclick="copyReferralLink()" class="w-full bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 shadow-lg hover:shadow-yellow-500/50 text-sm flex items-center justify-center gap-2"> 
            ...
            <div class="glass-card p-6 animate-fadeIn" style="animation-delay: 600ms;">
                 ...
                 <div class="space-y-3">
                     <a href="index.php?p=wallet" class="flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-200 group"> 
                        <div class="w-10 h-10 rounded-lg bg-purple-500/20 flex items-center justify-center group-hover:scale-105 transition-transform flex-shrink-0"><svg class="w-5 h-5 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"/></svg></div>
                        <div><div class="font-semibold text-white text-sm">Withdraw Tokens</div><div class="text-xs text-gray-400">Transfer to your wallet</div></div>
                        <svg class="w-4 h-4 text-gray-500 ml-auto group-hover:text-purple-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                     </a>
                     <a href="index.php?p=referrals" class="flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-200 group"> 
                        <div class="w-10 h-10 rounded-lg bg-yellow-500/20 flex items-center justify-center group-hover:scale-105 transition-transform flex-shrink-0"><svg class="w-5 h-5 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg></div>
                        <div><div class="font-semibold text-white text-sm">Referral Dashboard</div><div class="text-xs text-gray-400">View your earnings</div></div>
                        <svg class="w-4 h-4 text-gray-500 ml-auto group-hover:text-yellow-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                     </a>
                     <a href="index.php?p=profile" class="flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-200 group"> 
                        <div class="w-10 h-10 rounded-lg bg-cyan-500/20 flex items-center justify-center group-hover:scale-105 transition-transform flex-shrink-0"><svg class="w-5 h-5 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg></div>
                        <div><div class="font-semibold text-white text-sm">Profile Settings</div><div class="text-xs text-gray-400">Manage your account</div></div>
                        <svg class="w-4 h-4 text-gray-500 ml-auto group-hover:text-cyan-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                     </a>
                 </div>
            </div>
        </div>
...
<style>
    ...
    .status-pending, .status-processing { background-color: rgba(245, 158, 11, 0.2); color: #f59e0b; }
    ...
    @media (max-width: 640px) {
        #payment-modal > div { padding: 1.25rem; }
        #modal-title { font-size: 1.25rem; margin-bottom: 1rem; }
        #payment-summary { padding: 1rem; margin-bottom: 1rem; }
