<?php
// Premium Auth Form Component - ENHANCED UI
?>
<div class="glass-card p-6 md:p-8 relative overflow-hidden shadow-xl shadow-purple-900/30 border border-purple-500/20">
    ...
    <div class="relative z-10">
        ...
        <div class="grid grid-cols-2 gap-2 bg-black/40 p-1.5 rounded-lg mb-6 border border-white/10">
        ...
        <form id="form-login" class="space-y-4">
            ...
            <div class="flex items-center justify-between text-xs sm:text-sm -mt-2 mb-3"> 
        ...
        <form id="form-register" class="space-y-4 hidden">
            ...
            <button type="submit" id="register-btn" class="btn-primary w-full !py-3 !text-base group">
             ...
             <div class="bg-gradient-to-r from-emerald-900/30 to-cyan-900/30 border border-emerald-500/30 rounded-lg p-3 text-center text-xs mt-4"> {/* Added margin */}
                 <span class="text-emerald-300">🎁 Sign up to get <strong class="text-white"><?php echo number_format(KYC_BONUS); ?> GALAXY</strong> instantly!</span>
             </div>
